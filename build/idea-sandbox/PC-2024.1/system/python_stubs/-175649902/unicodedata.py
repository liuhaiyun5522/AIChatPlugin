# encoding: utf-8
# module unicodedata
# from /Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/unicodedata.cpython-312-darwin.so
# by generator 1.147
"""
...
ucd_3_2_0 = None # (!) real value is '<unicodedata.UCD object at 0x100d7d5c0>'

_ucnhash_CAPI = None # (!) real value is '<capsule object "unicodedata._ucnhash_CAPI" at 0x100bd6850>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x100bcdc70>'

__spec__ = None # (!) real value is "ModuleSpec(name='unicodedata', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x100bcdc70>, origin='/Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/unicodedata.cpython-312-darwin.so')"
