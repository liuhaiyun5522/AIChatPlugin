# encoding: utf-8
# module _contextvars
# from /Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/_contextvars.cpython-312-darwin.so
# by generator 1.147
""" Context Variables """
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x104f82a50>'

__spec__ = None # (!) real value is "ModuleSpec(name='_contextvars', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x104f82a50>, origin='/Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/_contextvars.cpython-312-darwin.so')"
