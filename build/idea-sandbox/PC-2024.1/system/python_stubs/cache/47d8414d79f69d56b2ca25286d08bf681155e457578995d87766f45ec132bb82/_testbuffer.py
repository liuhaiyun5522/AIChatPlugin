# encoding: utf-8
# module _testbuffer
# from /Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/_testbuffer.cpython-312-darwin.so
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x100d8a360>'

__spec__ = None # (!) real value is "ModuleSpec(name='_testbuffer', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x100d8a360>, origin='/Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/_testbuffer.cpython-312-darwin.so')"
