...
# from /Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/_testsinglephase.cpython-312-darwin.so
# by generator 1.147
...
_module_initialized = 824681.732157125
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x104edaae0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_testsinglephase', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x104edaae0>, origin='/Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/_testsinglephase.cpython-312-darwin.so')"
