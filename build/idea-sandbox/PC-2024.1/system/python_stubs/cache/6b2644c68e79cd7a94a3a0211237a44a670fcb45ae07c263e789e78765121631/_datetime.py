# encoding: utf-8
# module _datetime
# from /Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/_datetime.cpython-312-darwin.so
# by generator 1.147
...
datetime_CAPI = None # (!) real value is '<capsule object "datetime.datetime_CAPI" at 0x104e82af0>'

UTC = None # (!) real value is 'datetime.timezone.utc'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x104cf6360>'

__spec__ = None # (!) real value is "ModuleSpec(name='_datetime', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x104cf6360>, origin='/Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/_datetime.cpython-312-darwin.so')"
