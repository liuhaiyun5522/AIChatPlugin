# encoding: utf-8
# module cmath
# from /Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/cmath.cpython-312-darwin.so
# by generator 1.147
"""
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x1050be840>'

__spec__ = None # (!) real value is "ModuleSpec(name='cmath', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x1050be840>, origin='/Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/cmath.cpython-312-darwin.so')"
