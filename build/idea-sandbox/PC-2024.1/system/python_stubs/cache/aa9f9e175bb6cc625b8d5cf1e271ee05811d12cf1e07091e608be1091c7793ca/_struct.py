# encoding: utf-8
# module _struct
# from /Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/_struct.cpython-312-darwin.so
# by generator 1.147
"""
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x104bb96a0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_struct', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x104bb96a0>, origin='/Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/_struct.cpython-312-darwin.so')"
