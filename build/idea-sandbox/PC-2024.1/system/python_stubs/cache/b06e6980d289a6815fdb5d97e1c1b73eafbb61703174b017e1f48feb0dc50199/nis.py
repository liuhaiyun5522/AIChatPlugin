# encoding: utf-8
# module nis
# from /Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/nis.cpython-312-darwin.so
# by generator 1.147
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x10135e8d0>'

__spec__ = None # (!) real value is "ModuleSpec(name='nis', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x10135e8d0>, origin='/Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/nis.cpython-312-darwin.so')"
