...
expat_CAPI = None # (!) real value is '<capsule object "pyexpat.expat_CAPI" at 0x104c5eb80>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x104c5e9f0>'

__spec__ = None # (!) real value is "ModuleSpec(name='pyexpat', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x104c5e9f0>, origin='/Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/pyexpat.cpython-312-darwin.so')"
