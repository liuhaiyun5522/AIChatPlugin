...
executable = '/Users/liuhaiyun/PycharmProjects/pythonProject/.venv/bin/python'

exec_prefix = '/Users/liuhaiyun/PycharmProjects/pythonProject/.venv'
...
prefix = '/Users/liuhaiyun/PycharmProjects/pythonProject/.venv'
...
class __loader__(object):
    ...
    _ORIGIN = 'built-in'
    __dict__ = None # (!) real value is "mappingproxy({'__module__': '_frozen_importlib', '__doc__': 'Meta path import for built-in modules.\\n\\n    All methods are either class or static methods to avoid the need to\\n    instantiate the class.\\n\\n    ', '_ORIGIN': 'built-in', 'find_spec': <classmethod(<function BuiltinImporter.find_spec at 0x10438ef20>)>, 'create_module': <staticmethod(<function BuiltinImporter.create_module at 0x10438efc0>)>, 'exec_module': <staticmethod(<function BuiltinImporter.exec_module at 0x10438f060>)>, 'get_code': <classmethod(<function BuiltinImporter.get_code at 0x10438f1a0>)>, 'get_source': <classmethod(<function BuiltinImporter.get_source at 0x10438f2e0>)>, 'is_package': <classmethod(<function BuiltinImporter.is_package at 0x10438f420>)>, 'load_module': <classmethod(<function _load_module_shim at 0x10438e2a0>)>, '__dict__': <attribute '__dict__' of 'BuiltinImporter' objects>, '__weakref__': <attribute '__weakref__' of 'BuiltinImporter' objects>})"
...
implementation = None # (!) real value is "namespace(name='cpython', cache_tag='cpython-312', version=sys.version_info(major=3, minor=12, micro=4, releaselevel='final', serial=0), hexversion=51119344, _multiarch='darwin')"
...
meta_path = [
    None, # (!) real value is '<_virtualenv._Finder object at 0x10442b290>'
    __loader__,
    None, # (!) real value is "<class '_frozen_importlib.FrozenImporter'>"
    None, # (!) real value is "<class '_frozen_importlib_external.PathFinder'>"
    None, # (!) real value is '<six._SixMetaPathImporter object at 0x1051d6d20>'
]
...
path = [
    '/Users/liuhaiyun/.gradle/caches/9.2.1/transforms/5e460e4a8b53d653d356ce22ebd9f343/transformed/pycharm-community-2024.1-aarch64/plugins/python-ce/helpers',
    '/Users/liuhaiyun/.gradle/caches/9.2.1/transforms/5e460e4a8b53d653d356ce22ebd9f343/transformed/pycharm-community-2024.1-aarch64/plugins/python-ce/helpers/generator3',
    '/Users/liuhaiyun/.gradle/caches/9.2.1/transforms/5e460e4a8b53d653d356ce22ebd9f343/transformed/pycharm-community-2024.1-aarch64/plugins/python-ce/helpers',
    '/Library/Frameworks/Python.framework/Versions/3.12/lib/python312.zip',
    '/Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12',
    '/Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload',
    '/Users/liuhaiyun/PycharmProjects/pythonProject/.venv/lib/python3.12/site-packages',
]

path_hooks = [
    None, # (!) real value is "<class 'zipimport.zipimporter'>"
    None, # (!) real value is '<function FileFinder.path_hook.<locals>.path_hook_for_FileFinder at 0x1043d05e0>'
]

path_importer_cache = {} # real value of type <class 'dict'> skipped

stdlib_module_names = None # (!) real value is "frozenset({'_queue', 'genericpath', 'quopri', 'sched', 'site', 'pstats', 'cmath', 'pyexpat', 'getopt', 'turtledemo', 'pty', '_operator', 'random', '_collections', 'trace', 'zipfile', '_sha1', 'msilib', 'warnings', 'bz2', '_pydecimal', 'importlib', 'pydoc_data', 'traceback', 'sndhdr', 'io', 'html', 'zoneinfo', 'getpass', 'ossaudiodev', '_compression', 'collections', 'tarfile', 'itertools', 'profile', 'ftplib', 'netrc', 'resource', 'csv', '_datetime', 'array', '_elementtree', 'py_compile', 'email', '_csv', 'runpy', '_overlapped', 'graphlib', '_lzma', 'concurrent', 'cgi', 'sre_constants', '_tokenize', 'shelve', '_abc', 'shlex', 'heapq', '_osx_support', '_markupbase', 'cmd', 'idlelib', 'gc', 'logging', 'base64', 'linecache', '_dbm', '_curses', '_sitebuiltins', '_winapi', 'pkgutil', 'readline', '_asyncio', '_sqlite3', 'binascii', 'msvcrt', 'tomllib', 'urllib', 'curses', 'struct', 'compileall', 'nturl2path', 'dataclasses', 'unittest', '_codecs_tw', '_functools', 'gettext', 'glob', '_codecs_jp', 'functools', 'pipes', 'selectors', 'telnetlib', 'wsgiref', '_opcode', 'statistics', '_multiprocessing', '_statistics', 'imghdr', 'signal', 'pwd', 'wave', '_decimal', 'nis', 'dis', 'faulthandler', '_multibytecodec', '_strptime', 'enum', 'this', 'posixpath', 'datetime', 'string', 'time', 'pyclbr', '_codecs', 'fcntl', 'lib2to3', 'token', 'locale', 'tabnanny', 'venv', '_pylong', 'configparser', 'unicodedata', 'difflib', 'marshal', 'reprlib', 'zipapp', '_imp', '_io', '_sha2', 'pprint', 'asyncio', 'contextlib', 'sre_compile', 'secrets', 'cgitb', '_aix_support', '_blake2', 'aifc', 'pdb', 'plistlib', '_zoneinfo', '_hashlib', '_codecs_hk', '_bisect', 'ensurepip', 'queue', 'dbm', '_random', '_collections_abc', 'types', 'ast', 'filecmp', '_gdbm', '_socket', '_signal', 'copyreg', 'colorsys', 'crypt', '_msi', 'encodings', 'tkinter', '_heapq', 'calendar', 'opcode', '_weakref', 're', '_codecs_kr', 'nt', '_string', 'bisect', 'pydoc', 'uuid', 'inspect', 'posix', '_codecs_cn', '_contextvars', 'shutil', 'decimal', 'antigravity', 'rlcompleter', 'codecs', 'poplib', '_crypt', '_pyio', 'numbers', 'socket', '_curses_panel', 'zipimport', '_symtable', 'http', 'nntplib', 'symtable', 'ssl', 'sunau', 'hmac', 'mailbox', 'ipaddress', 'xmlrpc', 'zlib', 'platform', '_bz2', '_py_abc', '_warnings', '__future__', 'multiprocessing', '_uuid', 'copy', 'gzip', 'sys', '_struct', '_tracemalloc', 'fileinput', 'keyword', '_frozen_importlib_external', 'mimetypes', 'mmap', 'optparse', 'threading', 'fnmatch', '_locale', 'atexit', 'socketserver', '_stat', 'audioop', '_ssl', '_threading_local', 'pickle', 'tempfile', 'tracemalloc', 'typing', 'winsound', 'codeop', 'sysconfig', 'pathlib', 'turtle', 'uu', 'timeit', 'hashlib', 'ctypes', 'builtins', 'lzma', 'select', 'argparse', 'grp', 'chunk', 'tty', '_scproxy', '_posixsubprocess', '_pydatetime', 'cProfile', 'doctest', 'smtplib', '_tkinter', 'stat', '_typing', '_ast', '_json', 'errno', '_sha3', '_pickle', '_thread', '_lsprof', 'winreg', 'fractions', '_weakrefset', 'imaplib', 'modulefinder', '_compat_pickle', '_posixshmem', 'bdb', 'os', 'subprocess', 'contextvars', 'textwrap', 'sre_parse', 'mailcap', '_frozen_importlib', 'xml', 'webbrowser', 'termios', 'syslog', 'code', 'stringprep', '_sre', 'spwd', 'operator', 'sqlite3', 'weakref', 'json', 'xdrlib', 'abc', '_codecs_iso2022', 'math', '_ctypes', '_md5', 'pickletools', 'tokenize', 'ntpath'})"
