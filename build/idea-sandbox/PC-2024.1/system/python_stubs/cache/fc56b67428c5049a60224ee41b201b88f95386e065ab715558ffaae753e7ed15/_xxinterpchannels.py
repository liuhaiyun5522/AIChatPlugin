...
# from /Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/_xxinterpchannels.cpython-312-darwin.so
# by generator 1.147
"""
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x10365dc70>'

__spec__ = None # (!) real value is "ModuleSpec(name='_xxinterpchannels', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x10365dc70>, origin='/Library/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload/_xxinterpchannels.cpython-312-darwin.so')"
